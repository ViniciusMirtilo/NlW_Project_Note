...
export function NewCard({onNoteCreated}: NewNoteCardProps) {
    ...
    return (
      <Dialog.Root>
          <Dialog.Trigger className='rounded-md flex flex-col bg-stone-700  text-left p-5 gap-3 outline-none hover:ring-2 hover:ring-slate-600 focus:ring-2 focus:ring-lime-400'>
